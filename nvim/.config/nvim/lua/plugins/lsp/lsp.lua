return {
	...
	config = function()
		...
		local servers = {
			...
			ocamllsp = {
				cmd = { "/home/conor/.opam/default/bin/ocamllsp" },
				cmd_env = {
					PATH = "/home/conor/.opam/default/bin:" .. vim.env.PATH,
				},
				filetypes = {
					"ocaml",
					"ocaml.interface",
		...
		-- Exclude ocamllsp since it should be installed via opam, not Mason
		ensure_installed = vim.tbl_filter(function(item)
			return item ~= "ocamllsp"
		...
		local ocaml_config = servers.ocamllsp or {}
		ocaml_config.capabilities = vim.tbl_deep_extend("force", {}, capabilities, ocaml_config.capabilities or {})
		require("lspconfig").ocamllsp.setup(ocaml_config)
	end,
}
